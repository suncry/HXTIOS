//
//  HXTPropertyFeeMapViewController.m
//  ButlerCard
//
//  Created by johnny tang on 4/26/14.
//  Copyright (c) 2014 johnny. All rights reserved.
//

#import "HXTPropertyFeeMapViewController.h"
#import <MapKit/MapKit.h>

#define  kLastLongitude @"LastLongitude"
#define  kLastLatitude  @"LastLatitude"

@interface HXTPropertyFeeMapViewController () <MKMapViewDelegate>

@property (weak, nonatomic) IBOutlet MKMapView *mapView;

@end

@implementation HXTPropertyFeeMapViewController
...
//    [mapView userLocation].location.coordinate.latitude = (CLLocationDegrees)[[standard objectForKey:kLastLatitude] floatValue];
