...
#define kLineColor		[UIColor colorWithRed:114.0/255.0 green:237.0/255.0 blue:26.0/255.0 alpha:0.9]
#define kInnerColor		[UIColor colorWithRed:43.0/255.0 green:43.0/255.0 blue:43.0/255.0 alpha:0.75]
#define kHighlightColor	[UIColor colorWithRed:242.0/255.0 green:111.0/255.0 blue:14.0/255.0 alpha:1.0]
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        self.circleFillColour = kInnerColor;
        self.circleFillColourHighlighted = kHighlightColor;
        self.pathColour = kLineColor;
